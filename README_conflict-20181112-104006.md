...
PhD. Sem Vijverberg, who casted Kretschmer's original python code into a python code that can be applied in a versatile manner. Please give the link in your publication to the Github:
