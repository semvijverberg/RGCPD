...
This script is used to calculate and plot the correlation maps in Figure 5.
It also clusters the correlating regions (shown in SI-Figure 11). And makes
the predictions for the varying target months (shown in SI-Figure 12).
