...
list_import_ts = [('sstpattern', '/Users/semvijverberg/surfdrive/Scripts/RGCPD/publications/paper2/output/west/z5000..0..z500_sp_0ff31_10jun-24aug_lag0-0_0..0..z500_sp_random10s1/2020-07-06_16hr_04min_df_data_Pacific SST_z500_dt1_0ff31.h5'),
                  ('sstregions', '/Users/semvijverberg/surfdrive/Scripts/RGCPD/publications/paper2/output/west/z5000..0..z500_sp_0ff31_10jun-24aug_lag0-0_0..0..z500_sp_random10s1/2020-07-06_16hr_02min_df_data_Pacific SST_z500_dt1_0ff31.h5')]
...
list_for_MI = [BivariateMI(name='sst', func=BivariateMI.corr_map,
                        ...
                        calc_ts='region mean', selbox=(170,255,11,60))]
...
path_data = '/Users/semvijverberg/surfdrive/Scripts/RGCPD/publications/paper2/output/west/1ts_0ff31_10jun-24aug_lag0-0_ts_from_imports/2020-07-06_16hr_08min_df_data_sstpattern_sstregionssst_dt1_0ff31.h5'
...
SST_RW = ['0..1..Pacific SST', '0..2..Pacific SST', '0..3..Pacific SST', '0..4..Pacific SST']
SST_T  = ['0..1..sst', '0..2..sst', '0..3..sst', '0..4..sst']
...
list_of_fc = [fcev(path_data=path_data, precur_aggr=precur_aggr,
                    ...
                    dataset='',
                    keys_d=('SST from corr. map RW', dict(zip(np.arange(10), [SST_RW]*10)))),
               fcev(path_data=path_data, precur_aggr=precur_aggr,
                    ...
                    kwrgs_pp={'add_autocorr':False, 'normalize':'datesRV'},
                    dataset='',
                    keys_d=('SST from corr. map mx2t', dict(zip(np.arange(10), [SST_T]*10))))]
