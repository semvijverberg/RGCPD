...
path_raw = os.path.join(base_path,
                        ''.join([s.capitalize() for s in dataset]),
                        f'{exp_folder}')
...
ex = dict(
     {'dataset'     :       dataset,
     'grid_res'     :       1.0,
     'startyear'    :       1950, # download startyear
     'endyear'      :       1978, # download endyear
     ...
     'stream'       :       'mnth',
      'time'         :       pd.date_range(start='00:00', end='00:00',
